# Design Process Section Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Add a standalone `/process` page with a vertical timeline of 6 design phases, and a condensed teaser section on the About page linking to it.

**Architecture:** The `/process` page is a new route with a vertical timeline layout using the existing `GlassCard` component and framer-motion animations. The About page gets a new section between Achievements and Skills containing scrollable pill badges with a link to `/process`.

**Tech Stack:** Next.js (App Router), framer-motion, lucide-react, existing GlassCard component
...
### New Files
- `app/(pages)/process/page.jsx` — standalone process page with vertical timeline

### Modified Files
- `app/(pages)/about/page.jsx` — insert ProcessTeaser section between achievements and skills sections (line ~155-156 area)

---

## Task 1: Create `/process` Page

**Files:**
- Create: `app/(pages)/process/page.jsx`

- [ ] **Step 1: Write the page structure with Navbar, background effects, and container**
...
Run: `ls app/(pages)/process/page.jsx`

- [ ] **Step 3: Commit**

```bash
git add app/(pages)/process/page.jsx
git commit -m "feat: add standalone /process page with design process timeline
...
## Task 2: Add Process Teaser to About Page

**Files:**
- Modify: `app/(pages)/about/page.jsx`

- [ ] **Step 1: Add the process teaser section between Achievements and Skills**

Find this line in about/page.jsx (approximately line 155):
```jsx
          {/* Skills Section */}
```

Insert this new section directly above the `/* Skills Section */` comment block:
...
- [ ] **Step 2: Import ArrowRight in the existing import statement**

Find the existing lucide-react import in about/page.jsx (line 9):
```jsx
import { Trophy, Users, Star, Sparkles, Code2, Palette } from "lucide-react";
```

Add `ArrowRight` to the import:
```jsx
...
Run: `grep -n "Process Teaser" app/\(pages\)/about/page.jsx`

- [ ] **Step 4: Commit**

```bash
git add app/\(pages\)/about/page.jsx
git commit -m "feat: add design process teaser section to About page
...
- [ ] Visit `/process` in dev server — confirm 6 phase cards render with timeline layout
- [ ] Visit `/about` — confirm "My Process" teaser appears between Achievements and Skills
- [ ] Click "View Full Process" link on About page — should navigate to `/process`
- [ ] Verify animations fire correctly (cards fade in on scroll)
- [ ] Check mobile layout — timeline and pills should not overflow horizontally
