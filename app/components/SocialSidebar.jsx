...
const SocialSidebar = () => {
  ...
  return (
    <div
      className="fixed z-50 md:right-2 md:top-1/2 md:-translate-y-1/2 bottom-0 left-0 right-0 flex md:flex-col flex-row justify-center items-center gap-4 md:gap-2 p-3 md:p-2  backdrop-blur-md rounded-t-[12px] md:rounded-[12px] w-full md:w-12"
      style={{
